...
2 datasets were used from [Kaggle](https://www.kaggle.com/yamaerenay/spotify-dataset-19212020-160k-tracks), 'data_o' and 'data_by_year_o'. And 1 dataset, my personal streaming history sent by Spotify via email in j.son format.
...
We can see that as a personalized recommender,  still satisfies the diversity metric. However, what was observed is that the variety of genres in the recommendations based on John Legend's song was low with most of it being Hip Hop.  
...
I had also listened to these song recommendations and enjoyed most of them. Ultimately, it is still uncertain to say if this recommender is trustworthy or would do well with an average user. Therefore, a survey with a playlist generated by the recommender, was sent out to assess the demand for a recommender like this and if other people can hear similarities between songs. 
